        ...
        internal sealed class Database
        {
            ...
            private Database(string term, byte[] data)
            {
                ...
                _readAs32Bit =
                    ...
                    throw new InvalidOperationException(SR.IO_TermInfoInvalidMagicNumber); // magic number was not recognized. Printing the magic number in octal.
            ...
            internal extern static Database? ReadActiveDatabase();
