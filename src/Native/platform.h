...
#define JAMLINK0_BASE_ADDR  (0x50480000)
#define JAMLINK1_BASE_ADDR  (0x50490000)
#define JAMLINK2_BASE_ADDR  (0x504A0000)
#define JAMLINK3_BASE_ADDR  (0x504B0000)
#define JAMLINK4_BASE_ADDR  (0x504C0000)
#define JAMLINK5_BASE_ADDR  (0x504D0000)
#define JAMLINK6_BASE_ADDR  (0x504E0000)
#define JAMLINK7_BASE_ADDR  (0x504F0000)
