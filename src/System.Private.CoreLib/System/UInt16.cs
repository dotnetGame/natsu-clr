...
namespace System
{
    ...
    public readonly struct UInt16 : IComparable, IFormattable, IComparable<ushort>, IEquatable<ushort>, ISpanFormattable
    {
        ...
        {
            if (!Number.TryParseUInt32(s, style, info, out uint i)
                || i > MaxValue)
            {
                result = 0;
                return false;
