...
namespace System.Globalization
{
    public static partial class CharUnicodeInfo
    {
        ...
        internal static extern double InternalGetNumericValue(int ch);

        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern ushort InternalGetDigitValues(int ch);
        ...
        [MethodImpl(MethodImplOptions.InternalCall)]
        internal static extern byte InternalGetCategoryValue(int ch, int offset);
