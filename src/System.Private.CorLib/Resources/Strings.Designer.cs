namespace System
{
    internal static partial class SR
    {
        ...
        public static string AmbiguousImplementationException_NullMessage => @"Ambiguous implementation found.";
        ...
        public static string Arg_MustBeDriveLetterOrRootDir => @"Drive name must be a root directory (i.e. 'C:\') or a drive letter ('C').";
        ...
        public static string Argument_TypedReferenceInvalidField => @"Field '{0}' in TypedReferences cannot be static.";
        ...
        public static string ArgumentException_NotIsomorphic => @"Object contains non-primitive or non-blittable data.";
        ...
        public static string InvalidOperation_CannotRegisterSecondResolver => @"A resolver is already set for the assembly.";
        ...
        public static string InvalidOperation_SetLatencyModeNoGC => @"The NoGCRegion mode is in progress.End it and then set a different mode.";
        ...
        public static string InvalidOperation_TimerAlreadyClosed => @"The Timer was already closed using an incompatible Dispose method.";
        ...
        public static string MissingManifestResource_NoNeutralAsm => @"Could not find the resource ""{0}"" among the resources {2} embedded in the assembly ""{1}"", nor among the resources in any satellite assemblies for the specified culture. Perhaps the resources were embedded with an incorrect name.";
        ...
        public static string NotSupported_ByRefToByRefLikeReturn => @"ByRef to ByRef-like return values are not supported in reflection invocation.";
        public static string NotSupported_ByRefToVoidReturn => @"ByRef to void return values are not supported in reflection invocation.";
        ...
        public static string NotSupported_CollectibleWinRT => @"WinRT Interop is not supported for collectible types.";
        ...
        public static string InvalidOperation_SpanOverlappedOperation => @"This operation is invalid on overlapping buffers.";
        ...
        public static string ObjectDisposed_SafeHandleClosed => @"Safe handle has been closed.";
        ...
        public static string PlatformNotSupported_ITypeInfo => @"Marshalling a System.Type to an unmanaged ITypeInfo or marshalling an ITypeInfo to a System.Type is not supported on this platform.";
        public static string PlatformNotSupported_IExpando => @"Marshalling an IDispatchEx to an IReflect or IExpando is not supported on this platform.";
        public static string PlatformNotSupported_AppDomains => @"Secondary AppDomains are not supported on this platform.";
        public static string PlatformNotSupported_CAS => @"Code Access Security is not supported on this platform.";
        public static string PlatformNotSupported_Principal => @"Windows Principal functionality is not supported on this platform.";
        public static string PlatformNotSupported_ThreadAbort => @"Thread abort is not supported on this platform.";
        public static string PlatformNotSupported_ThreadSuspend => @"Thread suspend is not supported on this platform.";
        ...
        public static string Thread_ApartmentState_ChangeFailed => @"Failed to set the specified COM apartment state.";
        public static string Thread_GetSetCompressedStack_NotSupported => @"Use CompressedStack.(Capture/Run) instead.";
        public static string Thread_Operation_RequiresCurrentThread => @"This operation must be performed on the same thread as that represented by the Thread instance.";
        ...
        public static string Argument_CannotExtractScalar => @"Cannot extract a Unicode scalar value from the specified index in the input.";
        ...
        public static string AssemblyDependencyResolver_FailedToLoadHostpolicy => @"Cannot load hostpolicy library. AssemblyDependencyResolver is currently only supported if the runtime is hosted through hostpolicy library.";
        public static string AssemblyDependencyResolver_FailedToResolveDependencies => @"Dependency resolution failed for component {0} with error code {1}. Detailed error: {2}";
        public static string Arg_EnumNotCloneable => @"The supplied object does not implement ICloneable.";
        public static string InvalidOp_InvalidNewEnumVariant => @"The returned enumerator does not implement IEnumVARIANT.";
        ...
        public static string Serialization_DangerousDeserialization => @"An action was attempted during deserialization that could lead to a security vulnerability. The action has been aborted.";
        public static string Serialization_DangerousDeserialization_Switch => @"An action was attempted during deserialization that could lead to a security vulnerability. The action has been aborted. To allow the action, set the '{0}' AppContext switch to true.";
        public static string Argument_InvalidStartupHookSimpleAssemblyName => @"The startup hook simple assembly name '{0}' is invalid. It must be a valid assembly name and it may not contain directory separator, space or comma characters and must not end with '.dll'.";
        public static string Argument_StartupHookAssemblyLoadFailed => @"Startup hook assembly '{0}' failed to load. See inner exception for details.";
